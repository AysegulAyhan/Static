...
public class AlicesBookstoreTransaction {
    ...
    public static void main(String[] args) {
        AlicesBookstore.soldKids(1);
        AlicesBookstore.soldComics(5);
        AlicesBookstore.soldNovels(7);
      AlicesBookstore.soldRecipe(9);
      soldBook(5,2,1,0);
    ...
    public static int moneyEarned=0;
     public static void soldBook(int comics, int novels, int kids, int recipes){
        moneyEarned= (int) (comics*4.99+novels*7.55+kids*3+recipes*10);
         System.out.println("Total Amount of sales: $"+moneyEarned);
